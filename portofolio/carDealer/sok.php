...
<main class="bx4">
    ...
    if(isset($_GET["submit2"])) {
        $sql = sprintf("SELECT * FROM `finbil_v3`.`bil`,`finbil_v3`.`merke`,`finbil_v3`.`lokale`,`finbil_v3`.`drivstoff` WHERE bil.lokale=lokale.id and bil.drivstoff=drivstoff.id and merke.id=bil.merke and merke.id LIKE '%%%s%%'  order by opplastningsdato desc;",
